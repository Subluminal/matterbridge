...
func New(cfg config.Protocol, account string, c chan config.Message) *Bircd {
    b := &Bircd{}
    b.Config = &cfg
...
func (b *Bircd) Command(msg *config.Message) string {
    switch msg.Text {
    case "!users":
...
func (b *Bircd) JoinChannel(channel string) error {
    b.i.Join(channel)
    return nil
}

func (b *Bircd) Send(msg config.Message) error {
...
func (b *Bircd) endNames(event *irc.Event) {
...
func (b *Bircd) handleNewConnection(event *irc.Event) {
...
func (b *Bircd) handleJoinPart(event *irc.Event) {
...
func (b *Bircd) handleNotice(event *irc.Event) {
...
func (b *Bircd) handleOther(event *irc.Event) {
    switch event.Code {
...
func (b *Bircd) handlePrivMsg(event *irc.Event) {
...
func (b *Bircd) handleTopicWhoTime(event *irc.Event) {
...
func (b *Bircd) nicksPerRow() int {
    return 4
}

func (b *Bircd) storeNames(event *irc.Event) {
...
func (b *Bircd) formatnicks(nicks []string, continued bool) string {
