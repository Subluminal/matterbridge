...
[[gateway]]
    ...
    [[gateway.inout]]
    account="gitter.Subluminal"
    channel="Subluminal/testroom"
...
func TestNewRouter(t *testing.T) {
	...
	assert.Equal(t, &config.ChannelInfo{Name: "Subluminal/testroom", Direction: "out",
		ID: "Subluminal/testroomgitter.Subluminal", Account: "gitter.Subluminal",
		SameChannel: map[string]bool{"bridge2": false}},
		r.Gateways["bridge2"].Channels["Subluminal/testroomgitter.Subluminal"])
	assert.Equal(t, &config.ChannelInfo{Name: "Subluminal/testroom", Direction: "in",
		ID: "Subluminal/testroomgitter.Subluminal", Account: "gitter.Subluminal",
		SameChannel: map[string]bool{"bridge1": false}},
		r.Gateways["bridge1"].Channels["Subluminal/testroomgitter.Subluminal"])
